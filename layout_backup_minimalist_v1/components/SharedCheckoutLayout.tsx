...
interface SharedCheckoutLayoutProps {
  ...
  requiredFields?: any;
  isBrickReady?: boolean; // Deprecated, mantido para compatibilidade
  brickContainerId?: string; // Deprecated
...
export const SharedCheckoutLayout: React.FC<SharedCheckoutLayoutProps> = ({
  ...
  const content = (
    ...
    >
      ...
      <div>
        ...
        <div className="space-y-4">
          <SharedPaymentMethodSelector
              ...
              brickContainerId={brickContainerId}
              publicKey={publicKey}
              amount={amount}
      ...
      {/* O botão agora só aparece para PIX, pois o Cartão tem seu próprio botão no form */}
      {selectedPayment === 'pix' && (
        <>
          {/* Divisor adicionado antes do botão de pagamento */}
          <Divider />
  ...
  return (
    <div className="max-w-2xl mx-auto">
      {formWrapper ? formWrapper(content) : content}
    </div>
  );
};
