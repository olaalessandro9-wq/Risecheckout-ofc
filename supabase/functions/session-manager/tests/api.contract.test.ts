...
Deno.test({
  name: "api contract: returns 400 for unknown action",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
...
Deno.test({
  name: "api contract: revoke requires sessionId",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
...
Deno.test({
  name: "api contract: list response has correct structure",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
...
Deno.test({
  name: "api contract: revoke response has correct structure",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
...
Deno.test({
  name: "api contract: revoke-all response has correct structure",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
...
Deno.test({
  name: "api contract: revoke-others response has correct structure",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(FUNCTION_URL, {
      method: "POST",
