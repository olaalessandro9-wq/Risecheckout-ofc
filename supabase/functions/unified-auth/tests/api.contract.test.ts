...
Deno.test({
  name: "api contract: CORS preflight returns 204 for login",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: CORS preflight returns 204 for register",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: CORS preflight returns 204 for validate",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: CORS preflight returns 204 for refresh",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: CORS preflight returns 204 for logout",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: PUT method returns 405",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/login`, {
      method: "PUT",
...
Deno.test({
  name: "api contract: DELETE method returns 405",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/login`, {
      method: "DELETE",
...
Deno.test({
  name: "api contract: login returns 400 for missing email",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/login`, {
      method: "POST",
...
Deno.test({
  name: "api contract: login returns 400 for missing password",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/login`, {
      method: "POST",
...
Deno.test({
  name: "api contract: login returns 401 for invalid credentials",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/login`, {
      method: "POST",
...
Deno.test({
  name: "api contract: login response has correct structure",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: register returns 400 for missing email",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/register`, {
      method: "POST",
...
Deno.test({
  name: "api contract: register returns 400 for short password",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/register`, {
      method: "POST",
...
Deno.test({
  name: "api contract: validate returns 401 without token",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/validate`, {
      method: "POST",
...
Deno.test({
  name: "api contract: validate returns 401 with invalid token",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/validate`, {
      method: "POST",
...
Deno.test({
  name: "api contract: refresh returns 401 without refresh token",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/refresh`, {
      method: "POST",
...
Deno.test({
  name: "api contract: refresh returns 401 with invalid refresh token",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/refresh`, {
      method: "POST",
...
Deno.test({
  name: "api contract: logout returns 200 even without token",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/logout`, {
      method: "POST",
...
Deno.test({
  name: "api contract: password-reset-request returns 400 for missing email",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: password-reset-verify returns 400 for missing token",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: password-reset returns 400 for missing token",
  ignore: skipContract(),
  fn: async () => {
...
Deno.test({
  name: "api contract: password-reset returns 400 for missing password",
  ignore: skipContract(),
  fn: async () => {
    const response = await fetch(`${FUNCTION_URL}/password-reset`, {
      method: "POST",
...
Deno.test({
  name: "api contract: unknown action returns 404",
  ignore: skipContract(),
  fn: async () => {
...
// ============================================================================
// MOCK RESPONSE STRUCTURE TESTS (Unit - always runs)
// ============================================================================
