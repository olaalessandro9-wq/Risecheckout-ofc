...
Deno.test({
  name: "gdpr-request: export user data successfully",
  ignore: skipTests,
...
Deno.test({
  name: "gdpr-request: include all user data categories",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
...
Deno.test({
  name: "gdpr-request: require authentication",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
...
Deno.test({
  name: "gdpr-request: only allow access to own data",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
...
Deno.test({
  name: "gdpr-request: create request record",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
...
Deno.test({
  name: "gdpr-request: rate limit requests",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
...
Deno.test({
  name: "gdpr-request: export data in JSON format",
  ignore: skipTests,
  sanitizeResources: false,
  sanitizeOps: false,
  fn: async () => {
