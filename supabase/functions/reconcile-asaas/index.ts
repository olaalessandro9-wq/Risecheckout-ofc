 ...
 * ============================================================================
 * 
 * 1. Recebe lista de order_ids com gateway = 'asaas'
 * 2. Busca credenciais do Vault para cada vendor
 * 3. Consulta status na API Asaas
...
async function getAsaasStatus(
  paymentId: string,
  apiKey: string,
  sandbox: boolean = false
): Promise<{ status: string; confirmedDate?: string } | null> {
  try {
