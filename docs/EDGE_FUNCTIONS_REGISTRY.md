...
| `unified-auth` | public | false | general | SSOT - Login/Register/Refresh/Request-Refresh/Verify-Email/Resend-Verification/MFA-Setup/MFA-Verify-Setup/MFA-Verify/MFA-Disable endpoint |
| **Security & Crypto** | | | | |
