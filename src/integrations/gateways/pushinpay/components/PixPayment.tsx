 ...
 * 
 * Componente principal para pagamento via PIX usando PushinPay.
 * Gera QR Code, gerencia polling de status e countdown de expiração.
 * 
 * Migrado de: src/components/checkout/PixPayment.tsx
 */
