      ...
      <nav className="flex-1 space-y-6 overflow-y-auto p-3">
        ...
        <div>
          ...
          <div className="space-y-1">
            ...
            <SidebarItem to="/dashboard/produtos" icon={PackageSearch} label="Produtos" />
            {canHaveAffiliates && (
              <SidebarItem to="/dashboard/afiliados" icon={Users} label="Afiliados" />
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-1">
            <SidebarItem to="/dashboard/financeiro" icon={Wallet} label="Financeiro" />
            <SidebarItem to="/dashboard/integracoes" icon={Plug} label="Integrações" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-1">
            {canAccessAdminPanel && (
              <SidebarItem to="/dashboard/admin" icon={ShieldCheck} label="Administração" />
            )}
            ...
            {/* Ajuda (rota interna) */}
            <SidebarItem to="/dashboard/ajuda" icon={LifeBuoy} label="Ajuda" />
