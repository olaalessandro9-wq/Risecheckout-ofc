...
export function ConversionSection() {
  return (
    <section className="py-24 px-4 bg-white/5 relative z-10">
      ...
      <div className="container mx-auto max-w-6xl relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-block px-3 py-1 rounded-full bg-blue-500/20 text-blue-400 font-semibold text-sm mb-6">
              Maximize suas vendas
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Aumente seu faturamento com <span className="text-blue-500">ferramentas de conversão</span>
            </h2>
            ...
            <div className="space-y-4">
              {conversionFeatures.map((item, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl bg-[#0A0A0B] border border-white/5 hover:border-blue-500/30 transition-all"
                >
          ...
          >
            ...
            <div className="relative bg-[#0A0A0B] border border-white/10 rounded-2xl p-6 shadow-2xl shadow-black/50">
              {/* Header Mock */}
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <div className="font-semibold text-white">Curso Masterclass</div>
                      <div className="text-xs text-slate-400">Produto Principal</div>
                    </div>
                    <div className="font-bold text-white">R$ 497,00</div>
                  </div>
                </div>

                {/* Order Bump Highlight */}
                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30 relative overflow-hidden">
                  <div className="absolute -right-4 -top-4 bg-blue-600 text-[10px] font-bold px-6 py-1 rotate-45 text-white">OFERTA</div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <div className="font-bold text-white text-sm">Levar também a Mentoria VIP?</div>
                      <div className="text-xs text-slate-400 mt-1 mb-2">Adicione acompanhamento exclusivo por apenas mais R$ 97,00.</div>
                ...
                <Button className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold h-12 rounded-xl shadow-lg shadow-emerald-500/20">
                  Pagar Agora
                </Button>
              </div>
            </div>
