...
export function ImageCropDialog({
  ...
  const onImageLoad = useCallback((e: React.SyntheticEvent<HTMLImageElement>) => {
    ...
    // Define crop inicial centralizado (2:3)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[90vw] max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle>Recortar imagem do módulo</DialogTitle>
        </DialogHeader>
        ...
        <p className="text-sm text-muted-foreground text-center">
          Arraste as alças nos cantos e laterais para ajustar a área de recorte (proporção 2:3)
        </p>
