...
export function ModuleCardPreview({
  ...
  return (
    <div className={cn("w-full", className)}>
      <div className="relative w-full max-w-[240px] aspect-[2/3] rounded-xl overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-900 shadow-2xl ring-1 ring-white/10 mx-auto">
