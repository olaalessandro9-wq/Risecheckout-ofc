...
export function OverviewPanel({ metrics, isLoading }: OverviewPanelProps) {
  return (
    <div className="xl:col-span-1 bg-card/95 backdrop-blur-sm border border-border rounded-2xl p-4 md:p-6 flex flex-col min-h-[350px] md:min-h-[400px] lg:min-h-[450px]">
