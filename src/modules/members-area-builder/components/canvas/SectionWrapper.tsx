...
import { getSectionLabel, getSectionIcon, canMoveSection, isRequiredSection } from '../../registry';
...
export function SectionWrapper({
  ...
  const isRequired = isRequiredSection(section.type);
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        {/* Section Controls - Only movement controls */}
        {canMove && (
          <div 
            className={cn(
