...
export default function RedefinirSenha() {
  ...
  const validateToken = async () => {
    try {
      const response = await fetch(`${SUPABASE_URL}/functions/v1/producer-auth/verify-reset-token`, {
        method: "POST",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${SUPABASE_URL}/functions/v1/producer-auth/reset-password`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
          ...
          <div className="relative z-10 max-w-lg">
            ...
            >
              ...
              <p className="text-lg text-slate-400 leading-relaxed">
                Defina uma senha forte para proteger sua conta e continuar gerenciando suas vendas.
              </p>
            </motion.div>
          </div>
