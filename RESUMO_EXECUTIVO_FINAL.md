...
| `PUSHINPAY_WEBHOOK_TOKEN` | ⬜ Não configurada | Usar `<REDACTED_WEBHOOK_TOKEN>` |
...
export PUSHINPAY_WEBHOOK_TOKEN="<REDACTED_WEBHOOK_TOKEN>"
./scripts/configure-secrets.sh
```
...
6. `PUSHINPAY_WEBHOOK_TOKEN` (<REDACTED_WEBHOOK_TOKEN>)
...
**Valor padrão:** `<REDACTED_WEBHOOK_TOKEN>`

**Onde configurar:**
1. Supabase: `supabase secrets set PUSHINPAY_WEBHOOK_TOKEN="<REDACTED_WEBHOOK_TOKEN>"`
